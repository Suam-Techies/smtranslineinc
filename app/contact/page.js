...
export default function ContactPage() {
  return <InternalPage kicker="Contact us" title="Bring us your next challenge." intro="Tell us what you are building, improving, or trying to solve. We will get back to you with a useful next step.">
    ...
    <div className={styles.contactGrid}><div className={styles.contactCard}><strong>Call our office</strong><span>Speak with our team about your goals and timeline.</span><a href="tel:+18445853835">+1 844 585 3835 →</a></div><div className={styles.contactCard}><strong>Send an email</strong><span>Share a few details and we will respond as soon as possible.</span><a href="mailto:support@smtranslineinc.com">support@smtranslineinc.com →</a></div><div className={styles.contactCard}><strong>Visit our office</strong><span>701 W CAMBRIDGE AVE APT 204<br />FRESNO, CA, 93705</span></div></div>

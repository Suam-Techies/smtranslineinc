...
export default function PrivacyPolicyPage() {
  return <InternalPage kicker="Information" title="Privacy policy" intro="Effective September 15, 2026. This policy explains how SmTranslineInc handles information shared through this website.">
    ...
    <h2>Data choices</h2><p>You may contact us at <a href="mailto:support@smtranslineinc.com">support@smtranslineinc.com</a> to ask about the personal information we hold or to request an update or deletion, subject to applicable requirements.</p>
    <h2>Contact</h2><p>Questions about this policy can be sent to <a href="mailto:support@smtranslineinc.com">support@smtranslineinc.com</a>.</p>
  </InternalPage>;
}
